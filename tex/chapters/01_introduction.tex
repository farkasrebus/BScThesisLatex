...
\todo{cite{bengtsson2004timed}}. The abstract domain is called \emph{zone}, and it represents a set of reachable valuations of the clock
...
The idea of counterexample guided abstraction refinement (CEGAR) \todo{cite{clarke2003counterexample}} is to apply 
...
Several approaches have been proposed applying CEGAR on timed automata.  In \todo{cite{kemper2007sat}}
the abstraction is applied on the locations of the automaton. In
\todo{cite{nagaoka2010abstraction}} the abstraction of a timed automaton is an untimed
automaton. In \todo{cite{dierks2007automatic, he2010compositional}}, and
\todo{cite{okano2011clock}} abstraction is applied on the variables of the automaton.
...
\todo{Frissíteni, hivatkozni, végét megírni}
