...
The finite automaton (plural: automata)  is one of the most common formalisms for modelling behavior. This way the system is described by a finite set of possible states, and a set of steps defining the system's state changes.
